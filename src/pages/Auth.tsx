    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-hero-gradient items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative text-center max-w-md">
          <div className="w-16 h-16 rounded-2xl bg-primary-foreground/20 flex items-center justify-center mx-auto mb-8 backdrop-blur-sm">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground mt-1">
              {isLogin ? "Sign in to your Denbase account" : "Start your learning journey today"}
            </p>
          </div>
          ...
          {showForgotPassword ? (
            <form onSubmit={handleForgotPassword} className="space-y-4">
              ...
              <Button variant="hero" size="lg" className="w-full" disabled={resetLoading}>
